...
v0.1 — text-only, English + German articles (LLM handles other languages too). Built as the first dogfood project on top of the Loki bootstrap loop. See [the Loki essay](https://loki.orangecat.ch/thoughts/from-idea-to-first-commit-the-loki-bootstrap-loop) for the design context.
